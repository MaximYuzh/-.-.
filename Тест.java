...
class Calculator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите два числа (арабских или римских) не используя пробел между значениями:");
    ...
    public static String calc(String expression) throws Exception {
        ...
        int arabian = expression(num1, num2, oper);
        if (isRoman){
            if (arabian <= 0) {
    ...
    static int expression(int a, int b, String oper) {
